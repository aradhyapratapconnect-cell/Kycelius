...
exports.describeImageMetadata = describeImageMetadata;
...
function describeImageMetadata(meta) {
    const sizeKb = (meta.byteSize / 1024).toFixed(meta.byteSize < 1024 ? 0 : 1);
    const dims = meta.width !== null && meta.height !== null ? `${meta.width} x ${meta.height}px` : 'dimensions unknown';
    return (`Image: ${meta.format}, ${dims}, ${sizeKb} KB.\n` +
