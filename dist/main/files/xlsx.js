...
exports.XlsxParseError = void 0;
exports.extractXlsxText = extractXlsxText;
const zlib_1 = require("zlib");
const EOCD_SIG = 0x06054b50;
const CD_SIG = 0x02014b50;
class XlsxParseError extends Error {
}
exports.XlsxParseError = XlsxParseError;
...
function readZip(buffer) {
    ...
    for (let e = 0; e < totalEntries; e++) {
        ...
        if (method === 0)
            ...
            data = (0, zlib_1.inflateRawSync)(compressed);
        else {
...
function extractCellText(xml, sharedStrings) {
    const cells = [];
