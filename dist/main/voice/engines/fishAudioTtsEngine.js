...
exports.FISHAUDIO_PRESET_KEY = void 0;
exports.fishAudioTtsUrl = fishAudioTtsUrl;
exports.createFishAudioTtsEngine = createFishAudioTtsEngine;
const pcmWav_1 = require("../pcmWav");
const timeouts_1 = require("../../utils/timeouts");
const cloudUtils_1 = require("./cloudUtils");
exports.FISHAUDIO_PRESET_KEY = 'fishaudio_tts';
/** Production TTS model sent in the `model` header (the API default). */
const FISHAUDIO_MODEL = 's2.1-pro';
function fishAudioTtsUrl(baseUrl) {
    const base = baseUrl.replace(/\/+$/, '');
    return base.endsWith('/v1') ? `${base}/tts` : `${base}/v1/tts`;
}
function createFishAudioTtsEngine(config) {
    ...
    return {
        ...
        async synthesize(text) {
            ...
            const res = await (0, timeouts_1.fetchWithTimeout)(fishAudioTtsUrl(config.baseUrl), {
                method: 'POST',
                headers: {
