...
exports.UNSAFE_TOOL_ERROR = void 0;
exports.containsUnexecutedToolSyntax = containsUnexecutedToolSyntax;
exports.sanitizeAssistantText = sanitizeAssistantText;
/** Verbatim standard error — user-approved wording, do not rephrase. */
exports.UNSAFE_TOOL_ERROR = "Kyclius tried to do something it doesn't know how to do safely, so it stopped before acting. Try rephrasing your request.";
/**
...
function containsUnexecutedToolSyntax(text) {
    if (!text)
        return false;
...
function sanitizeAssistantText(text) {
    if (containsUnexecutedToolSyntax(text))
        return exports.UNSAFE_TOOL_ERROR;
    return text;
}
